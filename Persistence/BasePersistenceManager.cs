            ...
            foreach (var type in saveMap.Keys)
            {
                ...
                if (requiredPermissions != null)
                {
                    ...
                    foreach (var entityInfo in saveMap[type])
                    {
                        ...
                        {
                            case (Breeze.Persistence.EntityState)EntityState.Added:
                                requiredAction = Actions.Create;
                                break;
                            case (Breeze.Persistence.EntityState)EntityState.Modified:
                                requiredAction = Actions.Update;
                                break;
                            case (Breeze.Persistence.EntityState)EntityState.Deleted:
                        ...
                        if (entityInfo.EntityState is (Breeze.Persistence.EntityState)EntityState.Added or (Breeze.Persistence.EntityState)EntityState.Modified)
                        {
