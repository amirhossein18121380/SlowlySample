        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StampId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SlowlyUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interests_SlowlyUsers_SlowlyUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlowlyUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SlowlyUserId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Letters_SlowlyUsers_SlowlyUserId",
                        column: x => x.SlowlyUserId,
                        principalTable: "SlowlyUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Letters_SlowlyUsers_SlowlyUserId1",
                        column: x => x.SlowlyUserId1,
                        principalTable: "SlowlyUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stamps_SlowlyUsers_SlowlyUserId",
                        column: x => x.SlowlyUserId,
                        principalTable: "SlowlyUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Topics_SlowlyUsers_SlowlyUserId",
                        column: x => x.SlowlyUserId,
                        principalTable: "SlowlyUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLanguages_SlowlyUsers_SlowlyUserId",
                        column: x => x.SlowlyUserId,
                        principalTable: "SlowlyUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interests_SlowlyUserId",
                table: "Interests",
                column: "SlowlyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Letters_SlowlyUserId",
                table: "Letters",
                column: "SlowlyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Letters_SlowlyUserId1",
                table: "Letters",
                column: "SlowlyUserId1");

            migrationBuilder.CreateIndex(
                name: "IX_SlowlyUsers_UserId",
                table: "SlowlyUsers",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Stamps_SlowlyUserId",
                table: "Stamps",
                column: "SlowlyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Topics_SlowlyUserId",
                table: "Topics",
                column: "SlowlyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLanguages_SlowlyUserId",
                table: "UserLanguages",
                column: "SlowlyUserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Stamps_StampId",
                table: "AspNetUsers",
                column: "StampId",
